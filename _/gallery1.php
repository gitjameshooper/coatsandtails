...
<div class="container sub-header">
  ...
  <div class="samples">
    ...
    <a href="<?php echo $BASE_URL;?>img/samples/photoedits/bounds.jpg" data-lightbox="lightbox[digital]"><img src="<?php echo $BASE_URL;?>img/samples/photoedits/small/bounds.jpg" width="200" height="200" border="0" /> </a>
    ...
    <a href="<?php echo $BASE_URL;?>img/samples/photoedits/kali.jpg" data-lightbox="lightbox[digital]"><img src="<?php echo $BASE_URL;?>img/samples/photoedits/small/kali.jpg" width="200" height="200" border="0" /></a>
