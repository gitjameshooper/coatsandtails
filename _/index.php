				...
				<div id="home-carousel" class="carousel slide">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<a href="http://www.coatandtails.com/clothes.php?id=22">
								<div class="carousel-item-img img-thumbnail embed-responsive embed-responsive-4by2" style="background-image:url('<?php echo $CDN_IMGS;?>img/homepage/slide6.png');"></div>
							</a>
						</div>
						<div class="item">
