...
<div class="container sub-header">
        ...
        <div class="row">
            <p class="title-caption">This section shows photo edits for readymade clothes. These start at $25. You get a damn fancy print: a giclee print on acid-free, cold-press paper.</p>    
        </div>
    </div>
  <div class="samples">
