...
<div class="container w-bg center">
  ...
  <div class="style_examples" style="width:500px;float:left;">
  	...
  	<h1>Good</h1>
  	<img class="wall" src="/img/samples/good/1.jpg"  border="0" />
...
<h1>Good</h1>
    <img class="wall" src="/img/samples/good/14.jpg"  border="0" />
...
<h1>Good</h1>
    <img class="wall"  src="/img/samples/good/13.jpg"   border="0" />
...
<h1>Good</h1>
    <img class="wall"  src="/img/samples/good/4.jpg"   border="0" />
    ...
    <h1>Good</h1>
    <img class="wall" src="/img/samples/good/2.jpg"   border="0" />
    ...
    <h1>Good</h1>
    <img class="wall"  src="/img/samples/bad/2.jpg"   border="0" /> 
    ...
    <h1>Good</h1>
    <img class="wall"  src="/img/samples/bad/3.jpg"   border="0" />
    ...
    <h1>Good</h1>
    <img class="wall"  src="/img/samples/bad/5.jpg"   border="0" /> 
 ...
 <h1>Good</h1>
    <img class="wall"  src="/img/samples/bad/1.jpg"   border="0" />
