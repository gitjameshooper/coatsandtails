...
<div class="container sub-header">
  ...
  <div class="samples">  
    <a href="<?php echo $BASE_URL;?>img/samples/henryviii.jpg" data-lightbox="lightbox[digital]"><img src="<?php echo $BASE_URL;?>img/samples/small/henryviii.jpg" width="200" height="200" border="0" /></a>
...
<div class="container sub-header">
        ...
        <div class="row">
            <p class="title-caption">This section shows photo edits for readymade clothes. These start at $30. You get a damn fancy print: a giclee print on acid-free, cold-press paper.</p>    
        </div>
    </div>
  <div class="samples">
