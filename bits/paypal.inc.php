...
class paypal
{
	...
	var $form = array();
	var $log = 0;
	// var $form_action = 'https://www.paypal.com/cgi-bin/webscr'; // live: https://www.paypal.com/cgi-bin/webscr | sandbox: https://www.sandbox.paypal.com/cgi-bin/webscr
	// var $paypalurl = 'www.paypal.com';// live: www.paypal.com | sandbox: www.sandbox.paypal.com
	var $type = 'payment';
	...
	function output_form()
	{
		...
		$payload = '<div id="bod"><div id="wrapper"><table align=center id=main_table cellpadding=0 cellspacing=0 width=750px><tr><td width=314></td></tr><tr><td></td></tr><tr><td id="cart"></td></tr></table><table align=center cellpadding=0 cellspacing=0 width=750px><tr><td id=m_lbg></td><td id=m_table align=left>&nbsp;</td><td id=m_rbg></td></table><table cellpadding=0 cellspacing=0><tr><td height=20>&nbsp;</td></table><table align=center cellpadding=0 cellspacing=0 width=750px><tr><td align=center><font id=f3>You are now being redirecting to PayPal.</font><form name="f" action="'.$PAYPAL_API_ENDPOINT.'" method="post">';
		foreach($this->form as $k=>$v)
		{
			$payload .= '<input type="hidden" name="' . $k . '" value="' . $v . '" />';		}

		$payload .= '<input type="submit" class="btn btn-default" value="Click here if you are not redirected within 10 seconds" /></form></td></tr></table></div></div>';
		return $payload;
	}
